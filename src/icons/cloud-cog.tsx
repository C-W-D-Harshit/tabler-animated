...
const CloudCog_G_VARIANTS: Variants = {
  normal: { rotate: 0 },
  animate: { rotate: 180 },
};
...
const AnimatedCloudCog = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  ({ size = 24, strokeWidth = 2, color = "currentColor", onMouseEnter, onMouseLeave, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        >
          <title>CloudCog</title>
<path d="M4.2 15.1A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.2" />
          <motion.g
            animate={controls}
            transition={{ type: "spring", stiffness: 50, damping: 10 }}
            variants={CloudCog_G_VARIANTS}
          >
...
AnimatedCloudCog.displayName = "AnimatedCloudCog";

export default AnimatedCloudCog;
