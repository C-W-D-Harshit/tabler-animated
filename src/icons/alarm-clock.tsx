...
const AlarmClock_PATH_VARIANTS: Variants = {
  normal: {
    y: 0,
    x: 0,
    transition: {
...
const AlarmClock_SECONDARY_PATH_VARIANTS: Variants = {
  normal: {
    y: 0,
    x: 0,
    transition: {
...
const AnimatedAlarmClock = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
...
<motion.path
            ...
            d="M18 20.5L19.5 22"
            initial="normal"
            variants={AlarmClock_PATH_VARIANTS}
          />
          <motion.path
            animate={controls}
            d="M6 20.5L4.5 22"
          ...
          <motion.path
            ...
            initial="normal"
            variants={AlarmClock_SECONDARY_PATH_VARIANTS}
          />
          <motion.path
            animate={controls}
...
AnimatedAlarmClock.displayName = "AnimatedAlarmClock";

export default AnimatedAlarmClock;
