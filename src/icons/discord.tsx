...
const Discord_VARIANTS: Variants = {
  normal: {
    translateX: 0,
    opacity: 1,
    transition: {
...
const AnimatedDiscord = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
...
AnimatedDiscord.displayName = "AnimatedDiscord";
